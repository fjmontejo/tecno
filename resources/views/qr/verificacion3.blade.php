...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Validación de información de Incidentes por Fabricante</a>
  ...
  <section id="about">
      <div class="container">
          <p>
          <h5>  
           *En esta sección se encuentran los datos relevantes al formato de reporte incidentes por Fabricantes 
           para ser validados.
          </h5>
          </p>
        </div>
