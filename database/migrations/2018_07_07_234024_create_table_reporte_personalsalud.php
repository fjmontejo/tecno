...
class CreateTableReportePersonalsalud extends Migration
{
    ...
    public function up()
    {
        Schema::create('reporte_personalsalud', function (Blueprint $table) {
            ...
            $table->boolean('laboratorio',10)->nullable();
            $table->string('otro_lug',25)->nullable();
            $table->string('iniciales_noti',10)->nullable();
            $table->string('email',20)->nullable();
            $table->string('area_adscri',20)->nullable();
            $table->boolean('presento')->default(0)->nullable();
            //datos del operador del dispositivo
            $table->string('iniciales_ope',10)->nullable();
            ...
            $table->text('resumen_hclinic',50)->nullable();
            //info del incidente
            $table->date('fecha_incidente')->nullable(); 
            $table->string('lugar_estado',20)->nullable();
            $table->string('lugar_muni',20)->nullable();
            $table->string('lugar_locali',25)->nullable();
            ...
            $table->string('reporte',10)->nullable();
             ...
             //devuelto a
             $table->string('marcaodenom',25)->default(0)->nullable();
             $table->string('denominaciongene',25)->default(0)->nullable();
             $table->string('modelo_presentacion',25)->default(0)->nullable(); 
             $table->string('numero_lote',25)->default(0)->nullable();
             $table->string('nombre_fabricante',25)->default(0)->nullable();
             $table->string('numero_sanitario',25)->default(0)->nullable();

             $table->boolean('tratamiento')->default(0)->nullable();
             $table->boolean('diagnostico')->default(0)->nullable();
             $table->boolean('monitoreo')->nullable();
             $table->string('otro_uso',35)->nullable();
